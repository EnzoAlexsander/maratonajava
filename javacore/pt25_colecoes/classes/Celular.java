...
/*
    ...
    Se x.equals(y) == true, logo y.hashcode() == z.hashcode();
    y.hashcode() == x.hashcode() não necessariamente o equals deverá retornar true
    Se x.equals(y) == false não precisa ter nada no hashcode. Retornou falso é falso
    y.hashcode() != z.hashcode(), x.equals(y) deverá ser false
 */
